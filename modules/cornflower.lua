function define_cornflower()
	...
	cornflower_def = {
	  ...
	  desc = "In the past, Cornflowers grew as a weed in cornfields, hence its name. Its robustness and ability to survive drought has established the Cornflower as a symbol of hope and optimism for the future in many cultures.",
	  aquatic = false,
	  variants = 2,
	  deep = false,
	  smoker = {},
